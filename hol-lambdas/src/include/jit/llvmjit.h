...
extern PGDLLIMPORT LLVMTypeRef StructArrayType;
...
extern PGDLLEXPORT void llvm_enter_tmp_context(EState *state);
extern PGDLLEXPORT void llvm_leave_tmp_context(EState *state);
extern PGDLLEXPORT void llvm_close_tmp_context(EState *state);
...
extern PGDLLEXPORT Datum (*llvm_prepare_lambda_tablefunc(LLVMJitContext *context, char* bcModule,char* funcName, int numLambdas))(PG_FUNCTION_ARGS);

extern PGDLLEXPORT Datum (*llvm_prepare_simple_expression(ExprState *state))(Datum **);
extern PGDLLEXPORT Datum (*llvm_prepare_simple_expression_derivation(ExprState *state))(Datum **, Datum *);
