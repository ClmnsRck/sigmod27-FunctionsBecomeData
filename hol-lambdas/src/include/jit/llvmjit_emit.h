 ...
 */
static inline LLVMValueRef
l_as_float8(LLVMContextRef lc, LLVMBuilderRef b, LLVMValueRef v)
{
	return LLVMBuildBitCast(b, v, LLVMDoubleTypeInContext(lc), "");
}
 ...
 */
static inline LLVMValueRef
l_as_int4(LLVMContextRef lc, LLVMBuilderRef b, LLVMValueRef v)
{
	return LLVMBuildTruncOrBitCast(b, v, LLVMInt32TypeInContext(lc), "");
}
 ...
 */
static inline LLVMValueRef
l_as_int8(LLVMContextRef lc, LLVMBuilderRef b, LLVMValueRef v)
{
	return LLVMBuildBitCast(b, v, LLVMInt64TypeInContext(lc), "");
}
 ...
 */
static inline LLVMValueRef
l_float8_const(LLVMContextRef lc, float8 f)
{
	return LLVMConstReal(LLVMDoubleTypeInContext(lc), f);
}
