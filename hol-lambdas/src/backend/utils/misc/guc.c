...
InitializeGUCOptions(void)
{
	...
	DefineCustomBoolVariable(
		"custom_lambda_debugging_var",
		"Enable custom lambda debugging!",
		NULL,
		&custom_lambda_debugging_var,
		false,
		PGC_SUSET,
	...
	DefineCustomBoolVariable(
		"custom_lambda_hoisting_var",
		"Hoist higher-order lambda calls and execute them via lambda_injector.",
		"When on, higher-order lambda calls are flattened once per lambda "
		"combination and compiled into a single ExprState; when off, they are "
		"interpreted per row via nested CallLambdaExpr steps.",
		&custom_lambda_hoisting_var,
		true,
		PGC_USERSET,
		0, NULL, NULL, NULL
